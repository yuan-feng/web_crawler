...
def spider_question(url, verbose=1):
	...
	# this is necessary, sometimes, "This question link below has been deleted!" quickly.
	try:
	...
	try:
		...
		print "This question link below has no answers yet! \n"
		print url
		raw_answers="No answers for this question!"
